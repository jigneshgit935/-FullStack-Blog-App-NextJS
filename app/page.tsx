    ...
    <main className=" w-full h-full">
      ...
      <div className="w-full flex flex-col justify-center items-center">
        {posts?.map((post: any) => (
          <div
            key={post.id}
            className="border-2 border-slate-200 w-3/4 p-4 rounded-md mx-3 my-2 bg-slate-200 flex flex-col justify-center"
          >
            <div className="flex items-center my-3">
              ...
              <Link
                ...
                className=" bg-slate-900 px-4 py-1 text-center font-semibold text-slate-200 rounded-md text-xl"
              >
                Edit
              </Link>
            </div>
